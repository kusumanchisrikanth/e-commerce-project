...
router.post('/sendmail',function(req,res){
  users.findOne({_id:req.body.ownerid},function(err,docs){
    ...
    var mailOptions = {
      ...
      to: docs.email,
      subject: ' DEAL UP : Someone intrested on your product',
      text:  `a person of name ${req.session.user.name} is intrested on your product please contact him ${req.session.user.phone} is the phonenumber of your customer`
    };
